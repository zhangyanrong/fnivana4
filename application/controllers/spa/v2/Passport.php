...
class Passport extends CI_Controller {
	 ...
	 *
	 * @apiSampleRequest /spa/v2/?service=passport.mobile_vercode_login
	 **/
	 ...
	 * @apiParam {String} terminal 渠道?
	 *
	 * @apiSampleRequest /spa/v2?service=passport.wechat_login
	 */
	 ...
	 * @apiParam {String} [terminal]   渠道?
	 *
	 * @apiSampleRequest /spa/v2?service=passport.wechat_force_bind
	 */
